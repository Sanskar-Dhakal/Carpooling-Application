  ...
  Future<void> _geocode({
    ...
    try {
      ...
      final picked = PickedMapLocation(
         label: address.text,
         point: LatLng(
           (first['lat'] is num) ? (first['lat'] as num).toDouble() : double.tryParse(first['lat']?.toString() ?? '0') ?? 0.0,
           (first['lng'] is num) ? (first['lng'] as num).toDouble() : double.tryParse(first['lng']?.toString() ?? '0') ?? 0.0,
         ),
       );
      setState(() {
        ...
        child: ListView(
          ...
          children: [
            ...
            _LocationFields(
              ...
              onLocate: () => _geocode(
                  address: _originAddress, lat: _originLat, lng: _originLng),
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  const Text('Ride Details', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13.5, color: AppTheme.textPrimary)),
                      ...
                      Expanded(
                        child: AppTextField(
                          ...
                          validator: (value) {
                            ...
                            if (n == null || n < 1) return 'Enter seats';
                            return null;
                          },
                        ),
                      ),
                  ...
                  const SizedBox(height: 16),
                  const Text('Departure', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13.5, color: AppTheme.textPrimary)),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(AppTheme.radiusMd),
                        border: hasDeparture ? Border.all(color: AppTheme.driverColor.withOpacity(0.4)) : null,
                      ),
                      child: Row(
                        children: [
                          Icon(Icons.schedule_rounded, size: 19, color: hasDeparture ? AppTheme.driverColor : AppTheme.textSecondary),
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 14.5,
                                fontWeight: hasDeparture ? FontWeight.w700 : FontWeight.w500,
                                color: hasDeparture ? AppTheme.textPrimary : AppTheme.textTertiary,
                              ),
                            ),
                          ),
