                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: const [
                        Icon(Icons.directions_car_filled_rounded, color: AppTheme.primary, size: 22),
                        SizedBox(width: 8),
                        Text('HopON', style: TextStyle(color: AppTheme.primary, fontSize: 16, fontWeight: FontWeight.w800, letterSpacing: -0.3)),
                      ],
                    ),
                  ),
